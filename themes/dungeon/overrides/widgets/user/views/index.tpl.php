<form action="<?php echo url('user/login'); ?>" method="post">
	...
	<div class="text-right">
		<input type="submit" class="btn btn-connexion btn-cennexion" value="Connexion" />
		<a href="<?php echo url('user'); ?>" class="btn btn-inscrire" data-toggle="tooltip" title="S'inscrire sur le site"><i class="fa fa-sign-in"></i></a>
		<a href="<?php echo url('user/lost-password'); ?>" class="btn btn-question" data-toggle="tooltip" title="Mot de passe perdu ?"><i class="fa fa-question"></i></a>
	</div>
</form>
